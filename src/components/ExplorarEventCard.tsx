...
interface ExplorarEventCardProps {
    id: string | number;
    title: string;
    image: string;
    location: string;
...
const ExplorarEventCard: React.FC<ExplorarEventCardProps> = ({ id, title, image, location, date, time, sport }) => {
...
export default ExplorarEventCard;
