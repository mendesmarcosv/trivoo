# 🏆 Trivoo - Plataforma de Descoberta Esportiva
...
Para testar a aplicação, use o seguinte usuário já cadastrado:

```
Email: trivoo-testfiap@gmail.com
Senha: @TesteFiap1234
```
...
- **Cards Interativos**: Hover effects e transições suaves com foco visível
